from core.clearn import GenericContinualLearner
...
class Experiment(ABC):
    ...
    def __init__(self):
        self.algorithms: Dict[str, Callable[[], GenericContinualLearner]] = {}
    ...
    def add_algorithm_creator(self, label: str, algorithm: Callable[[], GenericContinualLearner]):
